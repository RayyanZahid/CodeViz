...
- [ ] **INFRA-01**: Graph snapshots are persisted to SQLite with layout positions included
- [ ] **INFRA-02**: Snapshot storage uses delta-threshold triggering (not wall-clock) to control growth
