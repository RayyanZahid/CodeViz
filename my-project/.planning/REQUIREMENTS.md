...
Requirements for v2.0 "Make It Live." Each maps to roadmap phases.

### Data Pipeline

- [ ] **PIPE-01**: Zod schemas in `GraphNodeSchema` accept `fileCount`, `keyExports`, and `dependencyCount` fields from WebSocket messages
- [ ] **PIPE-02**: Zod schemas in `GraphEdgeSchema` accept dependency metadata fields from WebSocket messages
...
- [ ] **INSP-01**: User can click a component node to open the Inspector panel
- [ ] **INSP-02**: Inspector shows component name and zone classification
- [ ] **INSP-03**: Inspector shows file count and list of files in the component
- [ ] **INSP-04**: Inspector shows key exports (important symbols the component provides)
